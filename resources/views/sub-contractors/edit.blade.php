            ...
            <form action="{{ route('sub-contractors.update', $subContractor->id) }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @error('contractor_type') is-invalid @enderror"
                ...
                <div class="row mb-3" id="third_party_row" style="display: none;">
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control @error('third_party_name') is-invalid @enderror"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control @error('amount_project') is-invalid @enderror"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Update Sub-Contractor
                        </button>
                        <a href="{{ route('sub-contractors.show', $subContractor->id) }}" class="btn btn-secondary ms-2">
